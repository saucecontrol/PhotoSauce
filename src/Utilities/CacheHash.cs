...
namespace PhotoSauce.MagicScaler
{
	internal static class CacheHash
	{
		...
		public static string Create(byte[] data) => encode(hashAlgorithm.ComputeHash(data));

		public static string Create(Stream data) => encode(hashAlgorithm.ComputeHash(data));
