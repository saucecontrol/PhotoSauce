...
namespace PhotoSauce.Interop.Libjxl
{
    internal static unsafe partial class Libjxl
    {
        ...
        [DllImport("jxl", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern JxlDecoderStatus JxlDecoderSetImageOutCallback([NativeTypeName("JxlDecoder *")] IntPtr dec, [NativeTypeName("const JxlPixelFormat *")] JxlPixelFormat* format, [NativeTypeName("JxlImageOutCallback")] delegate* unmanaged[Cdecl]<void*, nuint, nuint, nuint, void*, void> callback, [NativeTypeName("void *")] void* opaque);
