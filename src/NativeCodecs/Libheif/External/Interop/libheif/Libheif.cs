...
internal static unsafe partial class Libheif
{
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_load_plugin([NativeTypeName("const char *")] sbyte* filename, [NativeTypeName("const struct heif_plugin_info **")] heif_plugin_info** out_plugin);

    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_load_plugins([NativeTypeName("const char *")] sbyte* directory, [NativeTypeName("const struct heif_plugin_info **")] heif_plugin_info** out_plugins, int* out_nPluginsLoaded, int output_array_size);

    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_unload_plugin([NativeTypeName("const struct heif_plugin_info *")] heif_plugin_info* plugin);
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_context_read_from_memory([NativeTypeName("struct heif_context *")] void* param0, [NativeTypeName("const void *")] void* mem, [NativeTypeName("size_t")] nuint size, [NativeTypeName("const struct heif_reading_options *")] void* param3);
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int heif_context_get_encoder_descriptors([NativeTypeName("struct heif_context *")] void* param0, [NativeTypeName("enum heif_compression_format")] heif_compression_format format_filter, [NativeTypeName("const char *")] sbyte* name_filter, [NativeTypeName("const struct heif_encoder_descriptor **")] void** out_encoders, int count);
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_encoder_parameter_get_valid_integer_range([NativeTypeName("const struct heif_encoder_parameter *")] void* param0, int* have_minimum_maximum, int* minimum, int* maximum);
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_encoder_parameter_integer_valid_range([NativeTypeName("struct heif_encoder *")] void* param0, [NativeTypeName("const char *")] sbyte* parameter_name, int* have_minimum_maximum, int* minimum, int* maximum);
    ...
    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_register_decoder([NativeTypeName("struct heif_context *")] void* heif, [NativeTypeName("const struct heif_decoder_plugin *")] void* param1);

    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_register_decoder_plugin([NativeTypeName("const struct heif_decoder_plugin *")] void* param0);

    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("struct heif_error")]
    public static extern heif_error heif_register_encoder_plugin([NativeTypeName("const struct heif_encoder_plugin *")] void* param0);

    [DllImport("heif", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int heif_encoder_descriptor_supportes_lossy_compression([NativeTypeName("const struct heif_encoder_descriptor *")] void* param0);
